...
namespace WebPerson.Controllers
{
    public class PersonsDatasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Age,Name,Sex")] PersonsData personsData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Age,Name,Sex")] PersonsData personsData)
        {
